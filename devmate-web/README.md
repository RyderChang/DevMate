...
DevMate 的 Web 客户端。当前已具备注册、登录、会话恢复、受保护路由、退出登录，以及项目列表、创建、详情、编辑和删除流程。AI 对话、知识库、GitHub 集成、代码审查和测试生成等功能仍未实现。
...
当前范围完成前端认证与项目空间主流程。项目成员、管理员页面、刷新令牌、文件上传、AI、RAG、GitHub 集成、代码审查和测试生成均由后续独立任务实现。
